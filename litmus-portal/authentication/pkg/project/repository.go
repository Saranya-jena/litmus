...
func (r repository) GetProjectByProjectID(projectID string) (*entities.Project, error) {
	...
	//
	//authUsers, err := usermanagement.GetUsersFromAuth(ctx, uids)
	...
	//	member.FirstName = memberMap[member.UserID].FirstName
	//	member.UserName = memberMap[member.UserID].UserName
	//	member.UserStatus = memberMap[member.UserID].UserStatus
	//}
	//
	//if err != nil {
	//	return nil, err
...
func (r repository) GetProjectsByUserID(userID string, isOwner bool) ([]*entities.Project, error) {
	...
	if err != nil {
		// USE THIS LOG IN PROJECT HANDLER
