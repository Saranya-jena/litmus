...
import { WorkflowList } from '../../../../../models/graphql/workflowListData';
...
const TableToolBar: React.FC<TableToolBarProps> = ({
  ...
  const getClusters = (searchingData: WorkflowList) => {
    const uniqueList: string[] = [];
    searchingData.ListWorkflow.forEach((data) => {
    ...
    <div className={classes.workflowHead}>
      ...
      <div className={classes.filters}>
        ...
        <FormControl variant="outlined" className={classes.formControl} focused>
          <InputLabel className={classes.selectText}>Schedule</InputLabel>
          <Select
            value={scheduleValue}
