...
const WorkflowComparisonTable: React.FC<WorkflowComparisonTableProps> = ({
  data,
}) => {
  ...
  const handleSelectAllClick = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (data && event.target.checked) {
      const newSelects = data.map((n: Workflow) => n);
      ...
      <div className={classes.tableHeaderPaper}>
        <div className={classes.workflowHead}>
          <Typography className={classes.workflowText}>
            Aggregated stats of selected workflow and experiments
          </Typography>
        </div>
        <TableToolbar
